...
manuscript_format | NOT_READY | 8 | 0 main-text words; 6 display items | manuscript/nature_article_revised.md
...
submission_gate | NOT_READY | 1 | 18 evidence items are not complete. | manuscript/nature_article_revised.md; evidence/registry.yaml
