...
Root: .
CSV: evidence/evidence_artifact_status.csv

metric | value
--- | ---
artifact_rows | 113
missing_artifacts | 13
placeholder_files | 0

## Blocking artifacts

- robustness_falsification: results/validation/biome_metrics.csv (missing, placeholders=0)
- robustness_falsification: results/validation/sensor_cross_validation.csv (missing, placeholders=0)
- minimum_publishable_evidence_slice: figures/generated/pilot_fig1_stress_event_map.png (missing, placeholders=0)
- minimum_publishable_evidence_slice: figures/generated/pilot_fig2_precursor_pathway.png (missing, placeholders=0)
- minimum_publishable_evidence_slice: figures/generated/pilot_fig3_predictive_validation.png (missing, placeholders=0)
